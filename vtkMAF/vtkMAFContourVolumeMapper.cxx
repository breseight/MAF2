...
void vtkMAFContourVolumeMapper::SetInput(vtkDataSet *input)
//------------------------------------------------------------------------------
{
  this->ReleaseData();
  double b[2];
...
// Called by GetOutput()
template<typename DataType> void vtkMAFContourVolumeMapper::CreateMCubes_old(int level, vtkPolyData *polydata, const DataType *dataPointer) {
  //------------------------------------------------------------------------------
