...
/* DESCRIPTION
vtkMAFContourVolumeMapperAdv - a mapper for direct rendering of isosurfaces &
a filter for extracting them.

vtkMAFContourVolumeMapperAdv performs a direct rendering of isosurfaces and 
...
/* CONTENTS
namespace vtkMAFContourVolumeMapperAdvNamespace
class vtkMAFContourVolumeMapperAdv
class Polyline2DAdv
...
#ifndef __vtkMAFContourVolumeMapperAdv_h
#define __vtkMAFContourVolumeMapperAdv_h
...
private:
  ...
  vtkMAFContourVolumeMapperAdv(const vtkMAFContourVolumeMapperAdv&);
  /** operator =, not implemented.*/
  void operator=(const vtkMAFContourVolumeMapperAdv&);
