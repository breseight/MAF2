...
#ifndef __mafInteractor2DDistance_h
#define __mafInteractor2DDistance_h
...
*/
//----------------------------------------------------------------------------
class MAF_EXPORT mafInteractor2DDistance : public mafInteractorPER
	//----------------------------------------------------------------------------
{
public:
	mafTypeMacro(mafInteractor2DDistance, mafInteractorPER);
